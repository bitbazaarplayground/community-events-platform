...
//   const [email, setEmail] = useState("");
//   const [password, setPassword] = useState("");
//   const [adminCode, setAdminCode] = useState(""); // 🆕 discount/admin code
//   const [isSignUp, setIsSignUp] = useState(false);
//   const [error, setError] = useState(null);
//   const [loading, setLoading] = useState(false);
//   const [forgotMode, setForgotMode] = useState(false);
...
//         // 🧩 If tester enters ADMIN123, promote them immediately
//         if (adminCode.trim().toUpperCase() === "ADMIN123") {
//           await supabase
//             .from("user_profiles")
...
//           // ✅ Instant UI feedback
//           setError("🎉 You have been upgraded to Admin!");
//         } else if (!profile) {
//           // Create normal user profile if missing
//           await supabase
//             .from("user_profiles")
//             .insert([{ id: user.id, email: user.email, role: "user" }]);
//           console.log(`Created profile for ${user.email} as user`);
//         }

//         // ✅ Update local app state immediately
//         onLogin(user);

//         // ⏱ Small delay to ensure Supabase role syncs before redirect
//         setTimeout(() => {
...
//             {/* ✅ Show discount/admin code on both signup and login */}
//             <input
//               type="text"
//               placeholder="Discount Code (optional)"
//               className="w-full px-4 py-2 border rounded mb-4"
